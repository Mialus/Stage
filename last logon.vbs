' |Name: LastLogon.vbs
' |--------------------------------------------------------------------------
' |Script to determine the LastLogon of Users/Computers in a domain
' |Outputs the file to a log "LastLogon_<DATEBASE>.csv" as the execute folder.
' |
...
' |   >wscript LastLogon.vbs 3D
' |--------------------------------------------------------------------------
' |Version: 1.0 - initial release
' |Version: 2.0 - Added routines to query all AD controllers and report on 
' |               LastLogon attribute for the most accuracy.
...
strEmailFrom = "admins@domain.com" ' log e-mail FROM address
strEmailTo = "" ' log e-mail TO address
strEmailServer = "mx.domain.com" ' your e-mail server
